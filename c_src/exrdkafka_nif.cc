#include "exrdkafka_nif.h"
#include "nif_utils.h"
#include "macros.h"
#include "exrdkafka_logger.h"
#include "exrdkafka_producer.h"
#include "exrdkafka_consumer.h"
...
const char kAtomMessage[] = "exrdkafka_msg";
...
void open_resources(ErlNifEnv* env, exrdkafka_data* data)
{
...
int on_nif_load(ErlNifEnv* env, void** priv_data, ERL_NIF_TERM load_info)
{
    ...
    exrdkafka_data* data = static_cast<exrdkafka_data*>(enif_alloc(sizeof(exrdkafka_data)));
...
void on_nif_unload(ErlNifEnv* env, void* priv_data)
{
    ...
    exrdkafka_data* data = static_cast<exrdkafka_data*>(priv_data);
...
int on_nif_upgrade(ErlNifEnv* env, void** priv, void** old_priv, ERL_NIF_TERM info)
{
    ...
    exrdkafka_data* old_data = static_cast<exrdkafka_data*>(*old_priv);
    exrdkafka_data* data = static_cast<exrdkafka_data*>(enif_alloc(sizeof(exrdkafka_data)));
    open_resources(env, data);
...
static ErlNifFunc nif_funcs[] =
{
    ...
    {"produce_batch", 3, enif_produce_batch},
    {"produce_sync_batch", 3, enif_produce_sync_batch},
