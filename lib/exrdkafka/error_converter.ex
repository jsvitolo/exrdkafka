defmodule Exrdkafka.ErrorConverter do
  @moduledoc """
  Documentation for `Exrdkafka.ErrorConverter`.
  """
  ...
  @error_mapping [
    ...
    {18, :rd_kafka_resp_err_reco_rd_list_too_large},
  ...
  def get_readable_error(error) do
    case Enum.find(@error_mapping, fn {k, _} -> k == error end) do
      {_, result} -> result
      _ -> :undefined
    end
  end
